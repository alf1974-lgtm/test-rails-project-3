...
# db:schema:load`. When creating a portable database schema for a new environment,
# run `bin/rails db:schema:load` instead of `bin/rails db:migrate`.
#
...
ActiveRecord::Schema[7.1].define(version: 2024_01_01_000006) do
  ...
  create_table "enrollments", force: :cascade do |t|
    ...
    t.index ["student_id", "class_session_id"], name: "index_enrollments_on_student_id_and_class_session_id", unique: true
